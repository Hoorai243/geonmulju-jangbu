...
const GUIDES = [
  {
    ...
    steps: [
      ...
      '“직접 입력” 표시가 있는 건 바로 되돌려져요. “은행 확인” 표시가 있는 건 지문이나 비밀번호로 한 번 더 확인해요. (은행에서 확인된 기록이라 안전장치예요)',
    ],
  ...
  },
  {
    ...
    tip: '“직접 입력” 입금 되돌리기는 바로 돼요. “은행 확인” 입금 되돌리기와 세입자 삭제·백업 불러오기는 지문/비밀번호로 확인해요.',
  },
  {
